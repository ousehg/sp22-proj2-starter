...
class TestAbsLoss(TestCase):
    def test_simple(self):
        ...
        array1 = t.array([3, -42, 432, 7, -5, 6, 5, -114, 2])
        ...
        t.check_array(array2, [2, 40, 429, 11, 10, 12, 2, 106, 7])
...
class TestSquaredLoss(TestCase):
    def test_simple(self):
        ...
        t.call("squared_loss")
        # check that the result array contains the correct output
        t.check_array(array2, [4, 1600, 184041, 121, 100, 144, 4, 11236, 49])
        # check that the register a0 contains the correct output
        t.check_scalar("a0", 197299)
...
class TestZeroOneLoss(TestCase):
    def test_simple(self):
        ...
        # check that the result array contains the correct output
        t.check_array(array2, [0, 0, 0, 0, 0, 0, 0, 0, 0])
